...
export type TicketOrder = {
  ...
  linkId?: string;
  /** The payment behind it, captured at settle; what refunds target. */
  paymentId?: string;
  /** The number printed on Square's receipt; what their dashboard shows. */
  ...
  /** Percent off applied via a one-time reminder promo link. */
  promoPct?: number;
  /** The promo code this order rode in on; burned when the order is paid. */
  promoId?: string;
