...
export const capabilities: readonly Capability[] = [
  ...
  },
  {
    ...
    body: "Each date carries a real advertising and promotional budget, not just organic posts. We produce the creative, buy the placements, collect the signups, and keep the audience for the next one.",
    points: [
      "Paid social advertising",
      "Targeted local campaigns",
      "Professionally produced creative",
      "DJ and partner cross-promotion",
      "Signup and email collection",
